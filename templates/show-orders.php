<div class="hld_orders_wrap">
        <h1 style="margin-bottom: 15px;">My Order History</h1>
        <!-- Single Item -->
        <?php for ($i = 0; $i <= 7; $i++) {  ?>
            <div class="hld_item_wrap">
                <div class="left">
                    <div class="icon_wrap">
                        <svg width="40px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    ...
                    <div class="desc_wrap">
                        ...
                        <div class="detail_wrap">
                            <div>
                                <div class="wrap">
                                    <svg width="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            ...
                            <div>
                                <div class="wrap">
                                    <svg width="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            ...
                            <div>
                                <div class="wrap">
                                    ...
                                    <svg width="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
